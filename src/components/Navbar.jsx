...
//   return (
//     <nav
//       className={`fixed select-none z-40 mt-3 top-0 left-0 hidden md:flex justify-center w-full items-center py-4 px-4 transition-opacity duration-300 ${
//         isNavVisible ? "opacity-100" : ""
//       }`}
//     >
//       <div className="container flex justify-between items-center rounded-full bg-black border-[1px] border-[#212121] font-montserratR text-white py-4 backdrop-blur-sm  ">
